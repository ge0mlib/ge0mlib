program gComLogOvOut20191117; //Ge0MLib.com
...
begin
  clrscr;writeln('---gComLogOvOut20191117//Ge0MLib.com---');
  ...
  readln(f,SNcom2);Ncom2:=stralloc(16);strpcopy(Ncom2,SNcom2);writeln('Read: COM_Out Name=',SNcom2);
  ...
  PurgeComm(hcom2,PURGE_TXCLEAR or PURGE_RXCLEAR); //clear buffers
  //overlap
  ...
  repeat
    ...
    if ret<>0 then begin
      WriteFile(hcom2,char1,1,ret,nil);
  ...
  PurgeComm(HANDLE(hcom2),PURGE_TXCLEAR or PURGE_RXCLEAR);CloseHandle(hcom2);
end.
