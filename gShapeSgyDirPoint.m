function gShapeSgyDirPoint(shName,fName,FieldX,FieldY,NavS,NavP,CoordinateUnits,SourceGroupScalar,ChNum,fTable,selTable,sFields,ordF)
...
%{'SEQWR','Head.TraceSequenceFile(nn)','FFID','Head.FieldRecord(nn)','SP','Head.EnergySourcePoint(nn)','CDP','Head.cdp(nn)'} -- create SEQWR,FFID,SP,CDP numbers for each Shot (point).
...
%z={'Equipment','''Innomar SES-2000 Med''','IOGP_Code','''IOGP2306''','Day','datestr(gNavTime2Time(''YDy2Dx'',Head.YearDataRecorded(1),Head.DayOfYear(1)),20)','SEQWR','Head.TraceSequenceFile(nn)','FFID','Head.FieldRecord(nn)','SP','Head.EnergySourcePoint(nn)','CDP','Head.cdp(nn)'};
%gShapeSgyDirPoint('d:\202207_GeoXYZ_6\SBP_raw_track\Bl_point','d:\202207_GeoXYZ_6\SBP_raw_track\001_SEGY_Bl\','SourceX','SourceY',[],[],[],[],[],'d:\202207_GeoXYZ_6\SBP_raw_track\Bl.csv',1:4,z,[1:3 4 5 10 6 8 9 7 11:14]);
