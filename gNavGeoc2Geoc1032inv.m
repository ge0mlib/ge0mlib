...
%Convert coordinates from first geocentric reference system to second (coordinates conversion direction strict inverse)
%function [X2,Y2,Z2]=gNavGeoc2Geoc1032inv(X1,Y1,Z1,conv_dat), where
...
XYZ1=[X1;Y1;Z1];
XYZ2=1./(1+m).*inv(w)*(XYZ1-repmat(dxyz',1,size(XYZ1,2)));
